...
const SliderComponent = ({
  ...
  return (
    <section style={{ padding: "40px 20px", width: "100%", ...containerStyle }}>
      <header
        style={{
          display: "flex",
      ...
      >
        <h1 style={{fontSize:"2em",marginBottom:"1em", ...titleStyle}}>{title}</h1>
        ...
        >
          {items.map((item) => (
            ...
            >
              ...
              />
              <h3 style={{ fontSize: "20px", ...imageTitleStyle }}>
                {item.name}
              </h3>
            </Card>
          ))}
